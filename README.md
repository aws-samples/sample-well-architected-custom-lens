...
- Understanding of your AWS workload architecture

### How to import the custom lens

1. **Download the lens file:**
   - Download the lens file from the repository folder
...
- Navigate through the pillars systematically
...
1. Review the [AWS Well-Architected Tool documentation](https://docs.aws.amazon.com/wellarchitected/latest/userguide/intro.html)
